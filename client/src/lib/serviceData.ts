...
export const SERVICE_PAGES: ServicePageData[] = [
  {
    ...
    title: "坐廁通渠｜馬桶淤塞、倒灌處理及服務安排｜通渠熊",
    description:
      "坐廁去水慢、沖水後水位上升或馬桶倒灌？了解常見成因、通渠處理方法及施工前的準備事項。可先經 WhatsApp 傳送相片或影片索取初步估價。",
  ...
  },
  {
    ...
    description:
      "廚房鋅盤去水慢、倒灌或有異味？了解油脂、食物殘渣及隔氣堵塞的處理方法與服務安排。可經 WhatsApp 傳送影片索取初步估價。",
  ...
  },
  {
    ...
    name: "食肆隔油池清理",
    shortName: "隔油池清理",
    eyebrow: "GREASE TRAP CLEANING",
    title: "隔油池清理｜食肆油脂淤塞及排水保養｜通渠熊",
    description:
      "食肆隔油池積油、異味、滿溢或排水變慢？了解清理前要確認的設施、施工範圍、保養安排及施工前的準備事項，先提供現場資料再確認服務。",
    heroTitle: "隔油池積油、異味或滿溢，先確認清理範圍",
    heroDescription:
      "隔油池容量、油脂積聚、清潔口位置及營業時段都會影響處理安排。先了解現場條件，才較容易分辨是隔油池本身、下游喉管還是主渠問題。",
    answerSummary: {
      handles: "隔油池積油、異味、滿溢、排水變慢及食肆下游喉管淤塞。",
      suitableWhen:
        "食肆、商舖或共用廚房需要清理隔油設施，或懷疑油脂已影響下游排水。",
      limitation:
        "只清理隔油池未必能處理已在下游喉管形成的油垢，需按現場檢查判斷範圍。",
      confirmBeforeWork:
        "確認隔油池位置及容量、清潔口、排放安排、施工時段、清理範圍及最終收費。",
    },
    ...
    causes: [
      "油脂及食物殘渣長期進入隔油設施",
      "隔油池容量、分隔或沉澱空間不足以應付實際排放量",
      "清潔口、排放管或下游喉管積聚油垢",
      "營業高峰、季節或廚房運作改變令油脂負荷增加",
    ],
    process: [
      {
        title: "了解場所及設施",
        description:
          "先了解食肆用途、隔油池位置、容量、清潔口及最近一次清理紀錄。",
      },
      {
        title: "確認積油及排水範圍",
        description:
          "按水位、異味及下游排水情況，判斷需要處理隔油池本身還是連同喉管檢查。",
      },
      {
        title: "確認施工安排",
        description:
          "在動工前確認施工時段、出入口、排放及清理範圍，並說明最終總收費。",
      },
      {
        title: "清理及測試",
        description:
          "完成清理後測試相關去水位置，並交代仍需跟進的油垢、喉管或保養問題。",
      },
    ],
    priceFactors: [
      "隔油池容量、油脂厚度及沉積物數量",
    ...
    faqs: [
      {
        question: "隔油池多久需要清理一次？",
        answer:
          "沒有一個適用於所有食肆的固定週期。廚房排放量、隔油池容量、油脂種類及過往積油速度都會影響安排，應以實際水位和清理紀錄調整。",
      },
      {
        question: "清理隔油池後，廚房仍然去水慢是甚麼原因？",
        answer:
          "油垢可能已經在隔油池下游喉管或主渠內積聚，單靠清理池內油脂未必能恢復排水，需按受影響位置再作檢查。",
      },
      {
        question: "查詢隔油池清理要提供甚麼資料？",
        answer:
          "可先提供隔油池位置、清潔口相片、現時水位、上次清理日期、食肆營業時段及是否有其他去水位受影響，方便初步判斷設備和施工安排。",
      },
    ],
    relatedSlugs: [
      "high-pressure-jetting",
  ...
  },
  {
    ...
    description:
      "企缸塞、浴缸去水慢或沖涼後積水？了解頭髮、番梘垢及地台去水堵塞的常見成因、處理流程與服務安排，可經 WhatsApp 傳送影片作初步估價。",
  ...
  },
  {
    ...
    description:
      "污水渠倒灌、水渠倒灌或低層單位去水口湧出污水？了解即時安全措施、常見成因、檢查流程及施工前的準備事項，及早判斷局部支喉或大廈主渠問題。",
  ...
  },
  {
    ...
    description:
      "高壓水槍洗渠適合哪些油垢、主渠及反覆淤塞情況？了解施工方式、適用範圍、喉管限制、現場要求及施工前的準備事項，避免在未評估管道狀況前盲目施工。",
  ...
  },
  {
    ...
    description:
      "CCTV 照喉可協助查看管內淤塞、異物、接駁及可見破損情況，適合反覆淤塞、問題位置不明或維修前評估的排水管道。了解檢測流程、限制及施工前的準備事項。",
  ...
  },
  {
    ...
    description:
      "大廈主渠倒灌、沙井滿瀉或多個去水位同時淤塞？了解常見成因、現場檢查、處理流程、物業責任範圍及施工前的準備事項，並可經 WhatsApp 先提供資料作初步估價。",
