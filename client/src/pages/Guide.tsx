...
const CHOOSE_TIPS = [
  {
    title: "先報價、後動工",
    desc: "動工前先了解處理方法及總收費，確認報價後才安排施工。",
  },
  {
    title: "問清楚收費包含甚麼",
    desc: "報價應清楚列明工程範圍、處理方法及完工清潔安排，動工前由雙方確認。",
  },
  {
    title: "選擇有科技斷症的公司",
  ...
  {
    title: "留意「不成功不收費」條款",
    desc: "如服務設有「不成功不收費」，應在安排前了解適用項目及條款。",
  },
];
...
const HOWTO_STEPS = [
  ...
  },
  {
    step: "2",
    title: "確認收費及時段",
    desc: "團隊會先提供初步估價及可安排時段；師傅到場檢查後，於動工前確認最終總收費。",
  },
  {
    step: "3",
    title: "師傅到場疏通",
  ...
  return (
    <div className="phase4-guide bg-white" data-phase4-page="guide">
      <SEO
        ...
        description="查看坐廁、廚房鋅盤、企缸浴缸、大廈主渠、高壓洗渠及 CCTV 照喉的通渠價錢與費用參考，並了解報價及施工流程。"
        path="/guide"
